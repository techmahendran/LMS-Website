...
export const navbarStyles = {
  ...
  mobileMenuContainer: "bg-white/90 backdrop-blur-xl rounded-2xl p-4 border border-gray-200",
  ...
  mobileLogoutButton: "w-full flex items-center justify-bg-white/90 backdrop-blur-xl rounded-2xl p-4 shadow-lg border border-gray-200 space-x-2 p-3 rounded-xl bg-white text-gray-800 font-semibold shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300 mt-2",
